...
<div class="container mt-5">
    <h2 class="text-center">Manage Journals</h2>
        ...
        <tbody>
            ...
            if (!$stmt) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td>
                            <a href='update_status_j.php?type=journal&id={$row['id']}&status=1' class='btn btn-success btn-sm'>Accept</a>
                            <a href='update_status_j.php?type=journal&id={$row['id']}&status=-1' class='btn btn-danger btn-sm'>Reject</a>
                          </td>";
                    echo "</tr>";
                }
            }
