...
<div class="card">
 ...
 Hi! <?php echo strtoupper($_SESSION['username']);?>
  ...
  <div class="card-body">
    <h5 class="card-title">Welcome to My site</h5>
    <p class="card-text">We see your are logged in with "<?php echo''. $journal["user_ip"].'';?>
" IP address. <br>We have save it for future security propose.<br> <br>Do you want to create you first post on this site?</p> 
