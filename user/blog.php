...
$sql = "select * from blog where blog_slug='$blog_slug'";
...
$summernote = strip_tags($_POST['summernote']);
$date = $_POST['date'];
...
$run_query="INSERT INTO `blog` (`id`, `user_id`, `blog_title`, `blog_slug`, `blog_description`, `blog_cover`, `blog_date`, `blog_tags`, `blog_status`, `blog_trash`, `blog_creation`, `blog_last_update`, `ip`) VALUES (NULL, '$users', '$blog_title', '$blog_slug', '$summernote', '0', '$date', '0', '0', '0', '$create_date', '$create_date', '$user_ip')";
...
$sql_tags ="INSERT INTO `blog_tags` (`id`, `blog_id`, `tags`) VALUES (NULL, '$id', '$tags')";
...
<div id="Permalink">  
<label for="basic-url"><small class="text-muted">Author name</small></label>
<div class="input-group mb-3">
<div class="input-group-prepend">
<span class="input-group-text" id="basic-addon3">Author name:</span>
</div>
 <input type="text" class="form-control form-control-sm" name="blog_slug" id="blog_slug" placeholder="Author name" value="<?php if(isset($blog_slug)) {echo $blog_slug; }?>" size="40"/>   
...
@$insert_blog_images="INSERT INTO `blog_images` (`id`, `blog_id`, `image_url`) VALUES (NULL, '$id', '$img_full_link')";
$stmt = $con->prepare($insert_blog_images);   
$stmt->execute();       
    
//insert blog_cover    
@$insert_img="UPDATE `blog` SET `blog_cover` = '$img_full_link' WHERE `blog`.`id` = $id";     
